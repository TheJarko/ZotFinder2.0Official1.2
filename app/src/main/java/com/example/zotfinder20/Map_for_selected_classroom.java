...
public class Map_for_selected_classroom extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener, Safety_Dialog.SafetyDialogListener, Arrival_Dialog.ArrivalDialogListener {
    ...
    private Button button_back_to_select;
    ...
    private String[][] classroom_location_database = {
            ...
            {"DBH 1600", "","33.643404", "-117.841801"}, //This one is inaccurate
            ...
            {"SE2 1304", "","33.646546", "-117.839325"},
            {"SE2 1306", "","33.646546", "-117.839325"},
            ...
            {"HSLH 100A", "","33.645613", "-117.844692"},
            ...
            {"IAB 128", "","33.648287", "-117.845414"},
            {"IAB 129", "","33.648186", "-117.845235"},
            {"IAB 130", "","33.648287", "-117.845414"},
            {"IAB 131", "","33.648186", "-117.845235"},
            {"MM 216", "","33.649235", "-117.844688"},
            {"MM 220A", "","33.649235", "-117.844688"},
            {"MM 222", "","33.649235", "-117.844688"},
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                button_change.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (button_change.getText().equals(getString(R.string.sat))){
                            mapboxMap.setStyle(Style.SATELLITE_STREETS);
                            button_change.setText(R.string.map);
                        }else{
                            mapboxMap.setStyle(Style.MAPBOX_STREETS);
                            button_change.setText(R.string.sat);
                        }
                    }
                });


                button_back_to_select = findViewById(R.id.back_to_selection);
                button_back_to_select.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        finish();
                    }
    ...
    public void onReturnclicked() {
        Intent intent_go_back_from_selected_classroom_page = new Intent(this,MainActivity.class);
        startActivity(intent_go_back_from_selected_classroom_page);
        finish();
    }
